...
/*
#cgo CFLAGS: -Isrc
#cgo LDFLAGS: -Ldist/darwin -lsaplinglib -lpthread -ldl -framework Security
...
// GetZAddressOsx generates a shielded sapling address using a seed phrase
func GetZAddressOsx(nohd bool, zcount uint, iguanaSeed string, isIguanaSeed bool) IguanaSaplingAddress {
