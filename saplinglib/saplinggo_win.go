...
/*
#cgo CFLAGS: -Isrc
#cgo LDFLAGS: -Ldist/win64 -lsaplinglib -lpthread -ldl -framework Security
...
// GetZAddressWin generates a shielded sapling address using a seed phrase
func GetZAddressWin(nohd bool, zcount uint, iguanaSeed string, isIguanaSeed bool) IguanaSaplingAddress {
